...
MuzzleFlash::MuzzleFlash(AnimData animData, sf::Vector2f muzzlePosition, sf::Vector2f weaponBaseNormalized, float scale) : animData(animData), 
sprite(*animData.texture), muzzlePosition(muzzlePosition), weaponBaseNormalized(weaponBaseNormalized), scale(scale){
